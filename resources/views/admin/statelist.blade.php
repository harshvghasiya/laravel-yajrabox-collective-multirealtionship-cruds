    ...
    <div class="row">
        ...
        <div class="portlet box red">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-cogs"></i>Manage State
                </div>
                <div class="tools">
            ...
            <div class="portlet-body">
                <a href="{{url('createstate')}}" class="btn btn-info">Add state</a>
...
<script type="text/javascript">
  $(document).on('click', '#del_state', function(event) {
